class RunObjectIdentiferSiblingsController < ApplicationController
  ...
  def index
    @run_object_identifer_siblings = RunObjectIdentiferSibling.all
  end
  ...
  def new
    @run_object_identifer_sibling = RunObjectIdentiferSibling.new
  end
  ...
  def create
    @run_object_identifer_sibling = RunObjectIdentiferSibling.new(run_object_identifer_sibling_params)
  ...
  private
    ...
    def set_run_object_identifer_sibling
      @run_object_identifer_sibling = RunObjectIdentiferSibling.find(params[:id])
    end
