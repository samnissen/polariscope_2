class RunObjectIdentifersController < ApplicationController
  ...
  def index
    @run_object_identifers = RunObjectIdentifer.all
  end
  ...
  def new
    @run_object_identifer = RunObjectIdentifer.new
  end
  ...
  def create
    @run_object_identifer = RunObjectIdentifer.new(run_object_identifer_params)
  ...
  private
    ...
    def set_run_object_identifer
      @run_object_identifer = RunObjectIdentifer.find(params[:id])
    end
