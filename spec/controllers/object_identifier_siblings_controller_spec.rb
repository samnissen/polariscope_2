...
RSpec.describe ObjectIdentifierSiblingsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all object_identifier_siblings as @object_identifier_siblings" do
      object_identifier_sibling = ObjectIdentifierSibling.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:object_identifier_siblings)).to eq([object_identifier_sibling])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested object_identifier_sibling as @object_identifier_sibling" do
      object_identifier_sibling = ObjectIdentifierSibling.create! valid_attributes
      get :show, {:id => object_identifier_sibling.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested object_identifier_sibling as @object_identifier_sibling" do
      object_identifier_sibling = ObjectIdentifierSibling.create! valid_attributes
      get :edit, {:id => object_identifier_sibling.to_param}, valid_session
      expect(assigns(:object_identifier_sibling)).to eq(object_identifier_sibling)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ObjectIdentifierSibling" do
        expect {
          post :create, {:object_identifier_sibling => valid_attributes}, valid_session
      ...
      it "redirects to the created object_identifier_sibling" do
        post :create, {:object_identifier_sibling => valid_attributes}, valid_session
        expect(response).to redirect_to(ObjectIdentifierSibling.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved object_identifier_sibling as @object_identifier_sibling" do
        post :create, {:object_identifier_sibling => invalid_attributes}, valid_session
        expect(assigns(:object_identifier_sibling)).to be_a_new(ObjectIdentifierSibling)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested object_identifier_sibling" do
        object_identifier_sibling = ObjectIdentifierSibling.create! valid_attributes
        put :update, {:id => object_identifier_sibling.to_param, :object_identifier_sibling => new_attributes}, valid_session
      ...
      it "assigns the requested object_identifier_sibling as @object_identifier_sibling" do
        object_identifier_sibling = ObjectIdentifierSibling.create! valid_attributes
        put :update, {:id => object_identifier_sibling.to_param, :object_identifier_sibling => valid_attributes}, valid_session
        expect(assigns(:object_identifier_sibling)).to eq(object_identifier_sibling)
      end
      ...
      it "redirects to the object_identifier_sibling" do
        object_identifier_sibling = ObjectIdentifierSibling.create! valid_attributes
        put :update, {:id => object_identifier_sibling.to_param, :object_identifier_sibling => valid_attributes}, valid_session
        expect(response).to redirect_to(object_identifier_sibling)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the object_identifier_sibling as @object_identifier_sibling" do
        object_identifier_sibling = ObjectIdentifierSibling.create! valid_attributes
        put :update, {:id => object_identifier_sibling.to_param, :object_identifier_sibling => invalid_attributes}, valid_session
        expect(assigns(:object_identifier_sibling)).to eq(object_identifier_sibling)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested object_identifier_sibling" do
      object_identifier_sibling = ObjectIdentifierSibling.create! valid_attributes
      expect {
        delete :destroy, {:id => object_identifier_sibling.to_param}, valid_session
      }.to change(ObjectIdentifierSibling, :count).by(-1)
    end

    it "redirects to the object_identifier_siblings list" do
      object_identifier_sibling = ObjectIdentifierSibling.create! valid_attributes
      delete :destroy, {:id => object_identifier_sibling.to_param}, valid_session
      expect(response).to redirect_to(object_identifier_siblings_url)
    end
  end
